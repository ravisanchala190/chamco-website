...
const HERO_SLIDES = [
  { title: "The Service", body: "We design, build, and deploy innovative applications and automation solutions that transform business processes, enhance user experiences, and drive operational efficiency across the enterprise." },
  { title: "Custom Application Development", body: "Building tailored applications from the ground up using modern frameworks and cloud-native architectures to meet unique business requirements." },
  { title: "Process Automation", body: "Automating repetitive workflows and business processes using RPA, AI, and low-code platforms to increase efficiency and reduce human error." },
  { title: "API Integration & Management", body: "Designing and managing APIs that connect systems, data sources, and applications to create seamless, integrated digital ecosystems." },
];

const MOSAIC_CARDS = [
  { color: "#3d5afe", title: "Custom Software Development", summary: "Design and build bespoke software solutions tailored to your unique business needs, leveraging modern frameworks and agile development methodologies." },
  { color: "#7b1fa2", title: "Mobile App Development", summary: "Create intuitive, high-performance mobile applications for iOS and Android that deliver exceptional user experiences and drive customer engagement." },
  { color: "#00695c", title: "Robotic Process Automation (RPA)", summary: "Automate repetitive, rule-based tasks with RPA solutions that improve accuracy, reduce costs, and free your workforce to focus on higher-value activities." },
  { color: "#1565c0", title: "Low-Code / No-Code Development", summary: "Accelerate application delivery with low-code and no-code platforms that empower business users to build and modify apps without deep technical expertise." },
  { color: "#c62828", title: "API Development & Integration", summary: "Build robust APIs and integrate disparate systems to create connected, data-driven applications that streamline operations and enhance collaboration." },
  { color: "#f57f17", title: "UI/UX Design", summary: "Create intuitive, visually appealing user interfaces and experiences that delight users, drive adoption, and achieve business objectives." },
  { color: "#283593", title: "DevOps & CI/CD", summary: "Implement DevOps practices and CI/CD pipelines that accelerate software delivery, improve quality, and enable rapid iteration and innovation." },
  { color: "#2e7d32", title: "Legacy Modernization", summary: "Transform legacy systems into modern, cloud-native applications that improve performance, reduce maintenance costs, and enable digital innovation." },
];

const SOLUTION_BLOCKS = [
  { title: "Product Strategy & Design", body: "Define your product vision, validate ideas, and design user-centered solutions that solve real problems and deliver measurable business value." },
  { title: "Agile Development", body: "Build and iterate rapidly with our agile development teams. We deliver working software in short sprints, incorporating feedback and adapting to changing requirements." },
  { title: "Cloud-Native Architecture", body: "Design and build applications using cloud-native principles — microservices, containers, and serverless — for maximum scalability, resilience, and efficiency." },
  { title: "Quality Assurance & Testing", body: "Ensure application quality with comprehensive testing strategies including automated testing, performance testing, and security testing throughout the development lifecycle." },
  { title: "Post-Launch Support", body: "Maintain and evolve your applications with ongoing support, monitoring, and enhancement services that keep your software running optimally and aligned with business needs." },
];
...
export default function AppInnovationContent() {
  ...
  return (
    <main>
      ...
      {/* SECTION 1 — Hero */}
      <section className="svc-hero-row" style={{ display: "flex", height: "100vh", minHeight: "640px", backgroundImage: "url('/images/App-innovation-image.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="svc-hero-text" style={{ width: "60%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, paddingLeft: "6%", paddingRight: "5%", paddingBottom: "12%" }}>
            <h1 style={{ color: "white", fontWeight: 200, fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 1.05, margin: 0 }}>
              Build smarter apps.<br />Automate everything.
            </h1>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: "0", alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ flex: "0 0 45%", minWidth: "260px", paddingRight: "40px" }}>
              <h2 style={{ color: "#111111", fontWeight: 200, fontSize: "clamp(28px, 4vw, 52px)", lineHeight: 1.1, margin: 0 }}>
                Transform ideas into<br />powerful digital solutions.
              </h2>
            </div>
            <div style={{ flex: "0 0 55%", minWidth: "260px", paddingLeft: "60px", boxSizing: "border-box" }}>
              <p style={{ color: "#444444", fontSize: "16px", fontWeight: 300, lineHeight: "1.7", margin: 0 }}>
                From concept to deployment, we build innovative applications and automation solutions that solve real business challenges, improve efficiency, and create exceptional user experiences.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", overflow: "hidden", paddingBottom: '0', marginBottom: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.6", maxWidth: "700px", marginBottom: "48px" }}>
            Our app innovation and automation services help organizations build cutting-edge applications, automate processes, and create seamless digital experiences that drive growth.
          </p>
      ...
      <section style={{ backgroundColor: "#ebebeb", paddingTop: "60px", paddingBottom: "80px", marginTop: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444444", fontSize: "16px", lineHeight: "1.7", maxWidth: "600px", marginTop: "24px", fontWeight: 300 }}>
            Our app innovation experts work with you to design and build solutions that transform your business. From ideation to deployment, we deliver applications that make a real impact.
          </p>
        </div>
      </section>
      ...
      <section className="svc-darkrow" style={{ display: "flex", minHeight: "700px" }}>
        ...
        <div style={{ flex: 1, backgroundColor: "#1a1a1a", padding: "60px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <h2 style={{ color: "white", fontWeight: 700, fontSize: "clamp(22px, 2.5vw, 36px)", lineHeight: 1.2, marginBottom: "40px" }}>
            Your App Innovation Starts with Us
          </h2>
          <div>
