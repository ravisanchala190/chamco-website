...
const HERO_SLIDES = [
  { title: "The Service", body: "We help organizations modernize their workplace with Microsoft 365, Teams, and AI-powered tools that enable collaboration, productivity, and secure remote work at scale." },
  { title: "Microsoft 365 Deployment", body: "Deploying and configuring Microsoft 365 applications to enable seamless communication, collaboration, and productivity across your organization." },
  { title: "Collaboration & Communication Tools", body: "Implementing Microsoft Teams, SharePoint, and other collaboration platforms to connect distributed teams and streamline workflows." },
  { title: "Modern Workplace Security", body: "Securing modern work environments with identity management, device management, and data protection solutions that safeguard productivity." },
];

const MOSAIC_CARDS = [
  { color: "#3d5afe", title: "Microsoft 365 Implementation", summary: "Deploy and optimize Microsoft 365 applications including Teams, SharePoint, OneDrive, and Exchange to enable seamless collaboration and productivity." },
  { color: "#7b1fa2", title: "Microsoft Teams Adoption", summary: "Drive Teams adoption across your organization with change management, training, and governance frameworks that maximize the value of your investment." },
  { color: "#00695c", title: "SharePoint Intranet", summary: "Build modern SharePoint intranet solutions that centralize information, streamline communication, and foster a connected organizational culture." },
  { color: "#1565c0", title: "Power Platform Solutions", summary: "Leverage Power Apps, Power Automate, and Power BI to build custom business applications, automate workflows, and gain actionable insights." },
  { color: "#c62828", title: "Identity & Access Management", summary: "Implement Microsoft Entra ID and zero-trust security frameworks to secure identities, manage access, and protect against modern threats." },
  { color: "#f57f17", title: "Device Management (Intune)", summary: "Manage and secure employee devices with Microsoft Intune, enabling flexible work from any device while maintaining corporate security policies." },
  { color: "#283593", title: "Copilot for Microsoft 365", summary: "Unlock the power of AI in your workplace with Microsoft Copilot, automating tasks, generating insights, and enhancing productivity across M365 apps." },
  { color: "#2e7d32", title: "Change Management & Training", summary: "Ensure successful technology adoption with comprehensive change management programs and training that build digital skills and drive user engagement." },
];

const SOLUTION_BLOCKS = [
  { title: "Workplace Assessment", body: "Evaluate your current workplace tools and processes, identify opportunities for improvement, and develop a roadmap for modern workplace transformation." },
  { title: "Microsoft 365 Governance", body: "Establish governance frameworks for Microsoft 365 that ensure security, compliance, and effective use of your tenant across all applications." },
  { title: "Collaboration Strategy", body: "Develop a collaboration strategy that aligns Microsoft Teams, SharePoint, and other tools with your organizational workflows and communication needs." },
  { title: "AI & Automation Integration", body: "Integrate Microsoft Copilot and Power Platform into your workflows to automate routine tasks and unlock AI-powered productivity gains." },
  { title: "Ongoing Support & Optimization", body: "Maximize your Microsoft 365 investment with ongoing support, license optimization, and continuous improvement services." },
];
...
export default function ModernWorkContent() {
  ...
  return (
    <main>
      ...
      {/* SECTION 1 — Hero */}
      <section className="svc-hero-row" style={{ display: "flex", height: "100vh", minHeight: "640px", backgroundImage: "url('/images/Modern-work-image.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="svc-hero-text" style={{ width: "60%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, paddingLeft: "6%", paddingRight: "5%", paddingBottom: "12%" }}>
            <h1 style={{ color: "white", fontWeight: 200, fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 1.05, margin: 0 }}>
              Empower your workforce.<br />Work smarter, anywhere.
            </h1>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: "0", alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ flex: "0 0 45%", minWidth: "260px", paddingRight: "40px" }}>
              <h2 style={{ color: "#111111", fontWeight: 200, fontSize: "clamp(28px, 4vw, 52px)", lineHeight: 1.1, margin: 0 }}>
                Transform how<br />your people work.
              </h2>
            </div>
            <div style={{ flex: "0 0 55%", minWidth: "260px", paddingLeft: "60px", boxSizing: "border-box" }}>
              <p style={{ color: "#444444", fontSize: "16px", fontWeight: 300, lineHeight: "1.7", margin: 0 }}>
                The modern workplace demands flexibility, collaboration, and security. We help organizations adopt Microsoft 365 and modern work technologies that empower employees and drive productivity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", overflow: "hidden", paddingBottom: '0', marginBottom: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.6", maxWidth: "700px", marginBottom: "48px" }}>
            Our modern workplace solutions leverage Microsoft 365 and the latest collaboration technologies to create productive, secure, and flexible work environments.
          </p>
      ...
      <section style={{ backgroundColor: "#ebebeb", paddingTop: "60px", paddingBottom: "80px", marginTop: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444444", fontSize: "16px", lineHeight: "1.7", maxWidth: "600px", marginTop: "24px", fontWeight: 300 }}>
            Our modern workplace experts help organizations harness the full potential of Microsoft 365 and modern work technologies to create productive, secure, and flexible environments.
          </p>
        </div>
      </section>
      ...
      <section className="svc-darkrow" style={{ display: "flex", minHeight: "700px" }}>
        ...
        <div style={{ flex: 1, backgroundColor: "#1a1a1a", padding: "60px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <h2 style={{ color: "white", fontWeight: 700, fontSize: "clamp(22px, 2.5vw, 36px)", lineHeight: 1.2, marginBottom: "40px" }}>
            Your Modern Workplace Starts with Us
          </h2>
          <div>
