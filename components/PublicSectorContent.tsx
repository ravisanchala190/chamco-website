...
const MOSAIC_CARDS = [
  {
    ...
    summary: "Digital platforms that transform how citizens access government services — faster, simpler, and more accessible.",
    href: "/blog/citizen-centric-services",
  },
  {
    color: "#7b1fa2",
    image: "",
    title: "Operational Streamlining",
    summary: "AI and cloud automation tools that eliminate inefficiencies and modernize government operations at scale.",
    href: "/blog/operational-streamlining",
  },
  {
    color: "#00695c",
    image: "",
    title: "Data Transparency & Governance",
    summary: "Secure data platforms that enable open, transparent government data sharing and evidence-based policy.",
    href: "/blog/data-transparency",
  },
  {
    color: "#1565c0",
    image: "",
    title: "Cybersecurity Resilience",
    summary: "Government-grade security frameworks protecting critical infrastructure and sensitive citizen information.",
  ...
  },
  {
    ...
    summary: "Automated compliance monitoring ensuring government agencies meet evolving regulatory requirements.",
  ...
  },
  {
    ...
    summary: "AI models that forecast demand for public services, enabling proactive resource planning and allocation.",
    href: "/blog/predictive-analytics",
  },
  {
    color: "#283593",
    image: "",
    title: "Workforce Empowerment",
    summary: "Digital tools and AI training programs that upskill government workforces for the digital era.",
    href: "/blog/workforce-empowerment",
  },
  {
    color: "#2e7d32",
    image: "",
    title: "Scalable Cloud Infrastructure",
    summary: "Secure, compliant cloud infrastructure enabling government agencies to scale services efficiently.",
...
const HERO_SLIDES = [
  { title: "Citizen Services", body: "AI-powered digital services that improve citizen access, reduce wait times, and enhance service delivery across government agencies." },
  { title: "Operational Efficiency", body: "Cloud automation tools that streamline government workflows, reduce administrative burden, and lower operational costs." },
  { title: "Data Transparency", body: "Secure, compliant data platforms that improve government transparency and enable data-driven policy decisions." },
  { title: "Cybersecurity Resilience", body: "Government-grade cybersecurity frameworks protecting critical infrastructure and sensitive citizen data." },
];
      ...
      <div style={{ height: "3px", backgroundColor: "rgba(255,255,255,0.12)", flexShrink: 0 }}>
        <div
          ...
          style={{
            ...
            animation: "psDrain 10s linear forwards",
          }}
        />
      </div>
              ...
              {active === i && (
                <p
                  ...
                  style={{
                    ...
                    marginTop: "12px",
                    marginBottom: 0,
                    animation: "psBodyFade 0.4s ease-out",
                  }}
                >
                  {slide.body}
                </p>
...
function MosaicCard({ card, height }: { card: typeof MOSAIC_CARDS[0]; height: number }) {
  return (
    ...
    >
      ...
      <div className="ps-mc-overlay" style={{ position: "absolute", inset: 0, backgroundColor: "rgba(0,0,0,0.55)", zIndex: 2 }} />
      <div className="ps-mc-title" style={{ position: "absolute", bottom: "24px", left: "24px", right: "24px", zIndex: 3 }}>
        <h3 style={{ color: "white", fontWeight: 700, fontSize: "20px", margin: 0, lineHeight: "1.2" }}>{card.title}</h3>
      </div>
      <div className="ps-mc-summary" style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", padding: "28px", zIndex: 4 }}>
...
function PublicSectorMetrics() {
  ...
  const metrics = [
    {
      stat: "$1T+",
      text: "Global government IT spending projected to exceed $1 trillion annually by 2027.",
      icon: (
    ...
    {
      stat: "60%",
      text: "Of citizens expect government services to be as seamless as private sector digital experiences.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="#2563eb" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="10" cy="9" r="3.5" />
          <circle cx="18" cy="9" r="3.5" />
          <path d="M3 24 C3 19 6 16 10 16 C12 16 13 16.5 14 17" />
          <path d="M25 24 C25 19 22 16 18 16 C16 16 15 16.5 14 17" />
          <circle cx="14" cy="20" r="4" />
          <polyline points="12,20 13.5,21.5 16,18.5" />
        </svg>
      ),
    },
    {
      stat: "25–40%",
      text: "Operational efficiency gains achievable through AI-driven automation of government processes.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="#2563eb" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      stat: "#1",
      text: "Cybersecurity and data privacy are the top concerns for government digital transformation.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="#2563eb" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div
      ...
      style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "48px", marginTop: "72px" }}
    >
      {metrics.map((m, i) => (
        <div
          key={i}
        ...
        >
          <div style={{ width: "52px", height: "52px", backgroundColor: "#f4f6f9", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px" }}>
            {m.icon}
          </div>
          <div style={{ fontSize: "clamp(28px, 3vw, 40px)", fontWeight: 700, color: "#111111", lineHeight: 1, marginBottom: "10px", letterSpacing: "-0.5px" }}>
            {m.stat}
          </div>
          <p style={{ fontSize: "15px", color: "#555555", lineHeight: 1.55, margin: "0 0 14px 0", fontWeight: 300 }}>
            {m.text}
          </p>
  ...
  return (
    <main style={{ backgroundColor: "#ffffff" }}>
      <style>{`
        ...
        @keyframes psBodyFade {
          from { opacity: 0; }
          to   { opacity: 1; }
        }
        .ps-mc-card .ps-mc-overlay { opacity: 0; transition: opacity 0.3s ease; }
        .ps-mc-card:hover .ps-mc-overlay { opacity: 1; }
        .ps-mc-card .ps-mc-title { opacity: 1; transition: opacity 0.3s ease; }
        .ps-mc-card:hover .ps-mc-title { opacity: 0; }
        .ps-mc-card .ps-mc-summary { opacity: 0; transition: opacity 0.3s ease 0.15s; }
        .ps-mc-card:hover .ps-mc-summary { opacity: 1; }
      ...
      {/* SECTION 1 — Hero */}
      <section className="svc-hero-row" style={{ display: "flex", height: "100vh", minHeight: "640px", backgroundImage: "url('/images/Ind-Public-sector-image.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="svc-hero-text" style={{ width: "60%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, paddingLeft: "6%", paddingRight: "5%", paddingBottom: "12%" }}>
            ...
            <h1 style={{ color: "white", fontWeight: 200, fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, margin: 0 }}>
              Modernizing government<br />with AI &amp; cloud<br />technology.
            </h1>
            <p style={{ color: "#c0c8d8", fontSize: "16px", fontWeight: 300, maxWidth: "480px", marginTop: "24px", lineHeight: 1.7, marginBottom: 0 }}>
              Chamco Digital helps government agencies, public institutions, and non-profits harness AI and cloud solutions to deliver better citizen services, improve operational efficiency, and drive digital transformation across the public sector.
            </p>
          </div>
        </div>
      ...
      >
        <div style={{ display: "inline-flex", whiteSpace: "nowrap", animation: "psMarquee 35s linear infinite", animationPlayState: isHovered ? "paused" : "running" }}>
          {[0, 1].map((n) => (
          ...
          <div style={{ display: "flex", gap: "0", alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ flex: "0 0 45%", minWidth: "260px", paddingRight: "40px" }}>
              <h2 style={{ fontFamily: "inherit", fontWeight: 200, fontSize: "clamp(24px, 3.2vw, 52px)", color: "#111111", lineHeight: 1.1, textAlign: "left", margin: 0, whiteSpace: "nowrap" }}>
                ...
                <span style={{ display: "block" }}>solutions for the</span>
                <span style={{ display: "block" }}>Public Sector</span>
              </h2>
            </div>
            <div style={{ flex: "0 0 55%", minWidth: "260px", paddingLeft: "60px", boxSizing: "border-box" }}>
              <p style={{ color: "#444444", fontSize: "16px", fontWeight: 300, lineHeight: "1.7", margin: "0 0 20px 0" }}>
                Chamco Digital partners with government agencies and public institutions to deploy secure, scalable AI and cloud solutions that modernize service delivery, improve transparency, and drive operational excellence.
              </p>
      ...
      <section className="svc-darkrow" style={{ display: "flex", minHeight: "600px" }}>
        <div className="svc-darkrow-content" style={{ flex: 1, backgroundColor: "#ffffff", padding: "60px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <h4 style={{ color: "#111111", fontWeight: 600, fontSize: "18px", marginTop: "20px", marginBottom: 0 }}>Delivering smarter government, today</h4>
          <p style={{ color: "#333333", fontSize: "16px", fontWeight: 300, lineHeight: 1.7, marginTop: "16px", marginBottom: 0 }}>
            AI and cloud technologies are transforming how governments operate — enabling faster, more transparent citizen services, data-driven policy making, and secure, resilient public infrastructure.
          </p>
        </div>
        <div className="svc-darkrow-image" style={{ width: "50%", backgroundImage: "url('/images/business-5475661_1280.jpg')", backgroundSize: "cover", backgroundPosition: "center", flexShrink: 0 }} />
      </section>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", overflow: "hidden" }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.6", maxWidth: "700px", marginBottom: "48px" }}>
            Empowering government agencies and public institutions with AI and cloud solutions that improve service delivery, enhance transparency, and drive measurable outcomes for citizens.
          </p>
      ...
      <section style={{ position: "relative", background: "#ffffff", marginTop: "150px", marginBottom: "150px", paddingTop: "100px", paddingBottom: "80px", overflow: "hidden" }}>
        <span aria-hidden="true" style={{ position: "absolute", top: "10px", left: "4%", fontSize: "clamp(100px, 12vw, 160px)", fontWeight: 900, color: "#000000", opacity: 0.04, lineHeight: 1, letterSpacing: "-4px", pointerEvents: "none", userSelect: "none", zIndex: 0, whiteSpace: "nowrap" }}>GOVERNMENT</span>
        <div className="industry-context-container" style={{ position: "relative", zIndex: 1, maxWidth: "1240px", margin: "0 auto", paddingLeft: "80px", paddingRight: "80px" }}>
          ...
          <h2 style={{ fontSize: "clamp(36px, 4.5vw, 54px)", fontWeight: 700, color: "#111111", lineHeight: 1.15, letterSpacing: "-0.5px", maxWidth: "700px", margin: "0 0 28px 0" }}>
            Serving citizens better in an era of digital transformation
          </h2>
          <p style={{ fontSize: "18px", lineHeight: 1.6, color: "#444444", maxWidth: "680px", margin: "0", fontWeight: 300 }}>
            Governments worldwide are under pressure to modernize aging infrastructure, improve citizen services, and operate more efficiently with constrained budgets. AI and cloud technology offer a transformative path to smarter, more responsive public institutions.
          </p>
          <PublicSectorMetrics />
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "60px", paddingBottom: "80px" }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444444", fontSize: "16px", lineHeight: "1.7", maxWidth: "600px", marginTop: "24px", fontWeight: 300 }}>
            Partner with us to design and deploy AI and cloud solutions tailored for government and public sector needs. We ensure compliance, security, and measurable outcomes for citizens.
          </p>
        </div>
      </section>
