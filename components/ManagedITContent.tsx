...
const HERO_SLIDES = [
  { title: "The Service", body: "Our managed IT services provide comprehensive, proactive management of your IT infrastructure and operations, enabling you to focus on your core business while we ensure your technology runs optimally." },
  { title: "Proactive Monitoring & Management", body: "Continuously monitoring IT systems, identifying and resolving issues before they impact business operations through intelligent automation and expert oversight." },
  { title: "Help Desk & End-User Support", body: "Providing responsive, multi-tier technical support for end users, resolving issues quickly and efficiently to minimize productivity disruptions." },
  { title: "IT Strategy & Advisory", body: "Offering strategic IT guidance and technology roadmap planning to align IT investments with business goals and drive digital transformation." },
];

const MOSAIC_CARDS = [
  { color: "#3d5afe", title: "24/7 Monitoring & Alerting", summary: "Proactively monitor your IT infrastructure around the clock with intelligent alerting and automated remediation that prevents issues before they impact operations." },
  { color: "#7b1fa2", title: "Help Desk Services", summary: "Provide responsive, multi-tier technical support to your end users through phone, email, and chat, ensuring rapid issue resolution and high satisfaction." },
  { color: "#00695c", title: "Patch Management", summary: "Keep your systems secure and up-to-date with automated patch management that ensures timely deployment of critical security and feature updates." },
  { color: "#1565c0", title: "Backup & Disaster Recovery", summary: "Protect your data and ensure business continuity with automated backup solutions and tested disaster recovery plans that minimize downtime." },
  { color: "#c62828", title: "Vendor Management", summary: "Manage relationships with technology vendors, coordinate support escalations, and optimize licensing agreements to reduce complexity and cost." },
  { color: "#f57f17", title: "IT Asset Management", summary: "Track and manage your technology assets throughout their lifecycle, optimizing utilization, planning refreshes, and controlling costs." },
  { color: "#283593", title: "Compliance & Reporting", summary: "Maintain IT compliance with industry regulations and internal policies through continuous monitoring, documentation, and comprehensive reporting." },
  { color: "#2e7d32", title: "Virtual CIO Services", summary: "Access strategic IT leadership and technology advisory services through our vCIO program, aligning technology investments with your business strategy." },
];

const SOLUTION_BLOCKS = [
  { title: "IT Assessment & Onboarding", body: "Conduct a thorough assessment of your IT environment, document your infrastructure, and develop a tailored managed services plan that addresses your specific needs." },
  { title: "Proactive Maintenance", body: "Implement preventive maintenance programs that keep your systems healthy, secure, and performing optimally through regular updates, optimizations, and health checks." },
  { title: "Security Operations", body: "Protect your business with integrated security operations including threat monitoring, vulnerability management, and incident response as part of your managed services." },
  { title: "Technology Roadmap", body: "Develop a multi-year technology roadmap that aligns IT investments with business objectives, ensuring your technology evolves with your organization." },
  { title: "Scalable Support Model", body: "Scale IT support up or down as your business needs change, with flexible service tiers that provide the right level of support at every stage of growth." },
];
...
export default function ManagedITContent() {
  ...
  return (
    <main>
      ...
      {/* SECTION 1 — Hero */}
      <section className="svc-hero-row" style={{ display: "flex", height: "100vh", minHeight: "640px", backgroundImage: "url('/images/Managed-it-services-image.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="svc-hero-text" style={{ width: "60%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, paddingLeft: "6%", paddingRight: "5%", paddingBottom: "12%" }}>
            <h1 style={{ color: "white", fontWeight: 200, fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 1.05, margin: 0 }}>
              Expert IT management.<br />24/7 peace of mind.
            </h1>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: "0", alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ flex: "0 0 45%", minWidth: "260px", paddingRight: "40px" }}>
              <h2 style={{ color: "#111111", fontWeight: 200, fontSize: "clamp(28px, 4vw, 52px)", lineHeight: 1.1, margin: 0 }}>
                Reliable IT operations.<br />Strategic technology leadership.
              </h2>
            </div>
            <div style={{ flex: "0 0 55%", minWidth: "260px", paddingLeft: "60px", boxSizing: "border-box" }}>
              <p style={{ color: "#444444", fontSize: "16px", fontWeight: 300, lineHeight: "1.7", margin: 0 }}>
                Focus on growing your business while we manage your IT. Our managed services provide the expertise, tools, and proactive support needed to keep your technology running at peak performance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", overflow: "hidden", paddingBottom: '0', marginBottom: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.6", maxWidth: "700px", marginBottom: "48px" }}>
            Our managed IT services provide comprehensive support for your technology infrastructure, ensuring reliability, security, and performance across your entire IT environment.
          </p>
      ...
      <section style={{ backgroundColor: "#ebebeb", paddingTop: "60px", paddingBottom: "80px", marginTop: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444444", fontSize: "16px", lineHeight: "1.7", maxWidth: "600px", marginTop: "24px", fontWeight: 300 }}>
            Our managed IT experts become an extension of your team, providing the expertise and support needed to optimize your IT operations and drive technology-enabled business growth.
          </p>
        </div>
      </section>
      ...
      <section className="svc-darkrow" style={{ display: "flex", minHeight: "700px" }}>
        ...
        <div style={{ flex: 1, backgroundColor: "#1a1a1a", padding: "60px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <h2 style={{ color: "white", fontWeight: 700, fontSize: "clamp(22px, 2.5vw, 36px)", lineHeight: 1.2, marginBottom: "40px" }}>
            Your Managed IT Solution Starts with Us
          </h2>
          <div>
