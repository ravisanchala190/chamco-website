...
const HERO_SLIDES = [
  { title: "The Service", body: "Our EDI managed services provide end-to-end management of your electronic data interchange operations, ensuring seamless, secure, and compliant B2B transactions with trading partners." },
  { title: "EDI Implementation & Onboarding", body: "Implementing EDI solutions and onboarding trading partners quickly and efficiently, enabling electronic transactions across all major EDI standards." },
  { title: "EDI Monitoring & Operations", body: "Providing continuous monitoring of EDI transaction flows, proactive error detection, and rapid resolution to ensure uninterrupted B2B operations." },
  { title: "EDI Compliance & Standards", body: "Ensuring compliance with EDI standards including ANSI X12, EDIFACT, and industry-specific guidelines for retail, healthcare, logistics, and more." },
];

const MOSAIC_CARDS = [
  { color: "#3d5afe", title: "EDI Implementation", summary: "Implement EDI solutions that support all major standards and transaction sets, enabling seamless electronic commerce with trading partners across industries." },
  { color: "#7b1fa2", title: "Trading Partner Onboarding", summary: "Streamline the onboarding of new trading partners with standardized processes, testing environments, and dedicated support that accelerates time-to-transaction." },
  { color: "#00695c", title: "EDI Translation & Mapping", summary: "Translate EDI documents to and from internal formats with precision mapping that ensures data accuracy and compatibility across all systems." },
  { color: "#1565c0", title: "24/7 EDI Monitoring", summary: "Monitor EDI transaction flows around the clock with intelligent alerting, automatic error detection, and proactive resolution to prevent business disruption." },
  { color: "#c62828", title: "AS2 & VAN Connectivity", summary: "Establish secure, reliable EDI connectivity via AS2, SFTP, and Value-Added Networks, ensuring compliant and encrypted B2B data exchange." },
  { color: "#f57f17", title: "EDI Compliance Management", summary: "Maintain compliance with trading partner requirements and industry standards through ongoing governance, testing, and certification management." },
  { color: "#283593", title: "ERP Integration", summary: "Integrate EDI processes directly with your ERP and back-office systems to automate order-to-cash, procure-to-pay, and other critical business cycles." },
  { color: "#2e7d32", title: "EDI Analytics & Reporting", summary: "Gain visibility into your EDI operations with comprehensive analytics and reporting that track transaction volumes, errors, and partner performance." },
];

const SOLUTION_BLOCKS = [
  { title: "EDI Assessment & Strategy", body: "Evaluate your current EDI environment, identify improvement opportunities, and develop a strategy that optimizes your B2B transaction processes." },
  { title: "Cloud EDI Migration", body: "Migrate from legacy EDI platforms to modern cloud-based EDI solutions that offer greater scalability, visibility, and integration capabilities." },
  { title: "Partner Relationship Management", body: "Manage trading partner relationships, SLAs, and communications to ensure smooth, collaborative B2B operations across your entire partner network." },
  { title: "Error Resolution & Recovery", body: "Rapidly identify and resolve EDI errors with expert support that minimizes business impact and prevents recurring issues through root cause analysis." },
  { title: "EDI Modernization", body: "Modernize your EDI infrastructure with API-based integrations, real-time processing, and advanced analytics that position your B2B operations for the future." },
];
...
export default function EDIManagedServicesContent() {
  ...
  return (
    <main>
      ...
      {/* SECTION 1 — Hero */}
      <section className="svc-hero-row" style={{ display: "flex", height: "100vh", minHeight: "640px", backgroundImage: "url('/images/Edi-managed-services.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="svc-hero-text" style={{ width: "60%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, paddingLeft: "6%", paddingRight: "5%", paddingBottom: "12%" }}>
            <h1 style={{ color: "white", fontWeight: 200, fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 1.05, margin: 0 }}>
              Streamline B2B.<br />Automate EDI transactions.
            </h1>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: "0", alignItems: "flex-start", flexWrap: "wrap" }}>
            <div style={{ flex: "0 0 45%", minWidth: "260px", paddingRight: "40px" }}>
              <h2 style={{ color: "#111111", fontWeight: 200, fontSize: "clamp(28px, 4vw, 52px)", lineHeight: 1.1, margin: 0 }}>
                Automate your B2B transactions.<br />Eliminate manual errors.
              </h2>
            </div>
            <div style={{ flex: "0 0 55%", minWidth: "260px", paddingLeft: "60px", boxSizing: "border-box" }}>
              <p style={{ color: "#444444", fontSize: "16px", fontWeight: 300, lineHeight: "1.7", margin: 0 }}>
                Electronic Data Interchange is the backbone of modern B2B commerce. Our EDI managed services automate your trading partner transactions, reduce errors, and accelerate business cycles.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", overflow: "hidden", paddingBottom: '0', marginBottom: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.6", maxWidth: "700px", marginBottom: "48px" }}>
            Our EDI managed services provide complete management of your B2B electronic commerce, from implementation and partner onboarding to ongoing monitoring and compliance.
          </p>
      ...
      <section style={{ backgroundColor: "#ebebeb", paddingTop: "60px", paddingBottom: "80px", marginTop: '0' }}>
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          <p style={{ color: "#444444", fontSize: "16px", lineHeight: "1.7", maxWidth: "600px", marginTop: "24px", fontWeight: 300 }}>
            Our EDI experts manage your B2B electronic commerce operations so you can focus on your business. We ensure your EDI environment is reliable, compliant, and optimized for performance.
          </p>
        </div>
      </section>
      ...
      <section className="svc-darkrow" style={{ display: "flex", minHeight: "700px" }}>
        ...
        <div style={{ flex: 1, backgroundColor: "#1a1a1a", padding: "60px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <h2 style={{ color: "white", fontWeight: 700, fontSize: "clamp(22px, 2.5vw, 36px)", lineHeight: 1.2, marginBottom: "40px" }}>
            Your EDI Solution Starts with Us
          </h2>
          <div>
