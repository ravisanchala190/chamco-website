...
export default function AIWorkforceEnablementContent() {
  ...
  return (
    <>
      <style>{`
        .awe-share-icon:hover { background: #2563eb !important; }
        .awe-related-card { transition: box-shadow 0.2s; }
        .awe-related-card:hover { box-shadow: 0 8px 24px rgba(0,0,0,0.12); }
        .awe-read-more { color: #2563eb; text-decoration: none; font-size: 13px; font-weight: 600; }
        .awe-read-more:hover { text-decoration: underline; }
        .awe-cta-btn { transition: background-color 0.2s; }
        .awe-cta-btn:hover { background-color: #1d4ed8 !important; }
        .awe-article-subheading { font-size: 24px; font-weight: 700; color: #111111; margin-top: 48px; margin-bottom: 16px; line-height: 1.3; }
        .awe-pull-quote { border-left: 4px solid #2563eb; padding-left: 24px; font-size: 22px; font-style: italic; color: #333333; margin: 40px 0; line-height: 1.6; }
        .awe-body p { font-size: 18px; line-height: 1.8; color: #1a1a1a; font-weight: 300; margin: 0 0 28px 0; }
      ...
      <section>
        <Image
          ...
          alt="AI Workforce Enablement Emerges as a Strategic Imperative"
          width={1600}
          height={480}
          unoptimized
          priority
      ...
      <section style={{ backgroundColor: "#ffffff", paddingTop: "80px", paddingBottom: 0 }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", paddingLeft: "24px", paddingRight: "24px" }}>
          ...
          <p style={{ fontSize: "22px", fontWeight: 300, color: "#444444", marginTop: "12px", marginBottom: 0, lineHeight: 1.4 }}>
            Closing the AI readiness gap through scalable training, measurable skills development, and leadership-driven transformation.
          </p>

          {/* Author */}
          <p style={{ fontSize: "14px", color: "#555555", marginTop: "24px", marginBottom: 0 }}>
            By Dave Phillips, AI Consultant, Chamco Digital
          </p>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginTop: "20px" }}>
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/chamcodigital/?viewAsMember=true"
              target="_blank"
              rel="noopener noreferrer"
              className="awe-share-icon"
      ...
      <section style={{ maxWidth: "740px", margin: "0 auto", padding: "80px 24px" }}>
        <div className="awe-body">
          ...
          <h2 className="awe-article-subheading">The Readiness Gap Is Real — and Costly</h2>
          <p>
          ...
          <blockquote className="awe-pull-quote">
            The primary barrier to AI value realization is not access to technology — it is organizational capability.
          </blockquote>

          <h2 className="awe-article-subheading">From Awareness to Applied Competency</h2>
          <p>
            Effective AI workforce enablement goes beyond introductory awareness sessions. The programs that produce measurable outcomes combine structured certification pathways — such as the Microsoft AI-900 and AI-102 tracks — with hands-on lab environments, real-world project work, and role-specific application. This approach produces practitioners who can deploy AI solutions, govern AI systems responsibly, and continuously build on their capabilities as the technology evolves. Cohort-based delivery models amplify these outcomes by creating communities of practice within organizations that sustain learning beyond the formal program.
          </p>

          {/* Workforce Enablement Strip — full-bleed */}
          <section style={{
            width: '100vw',
            ...
            <div style={{ textAlign: 'center', marginBottom: '56px' }}>
              ...
              <h2 style={{
                ...
                margin: 0,
                lineHeight: 1.15,
              }}>The capability stack powering enterprise AI readiness</h2>
            </div>
            ...
            <div style={{
              ...
              {[
                { category: 'CERTIFICATION', name: 'Microsoft AI-102' },
                { category: 'FOUNDATION', name: 'Azure AI-900' },
                { category: 'CLOUD PLATFORM', name: 'Microsoft Azure' },
                { category: 'PRODUCTIVITY AI', name: 'Microsoft Copilot' },
                { category: 'AI PLATFORM', name: 'Azure AI Foundry' },
                { category: 'DELIVERY MODEL', name: 'Cohort-Based Learning' },
                { category: 'HANDS-ON', name: 'Azure Lab Environments' },
                { category: 'OUTCOME', name: 'Job-Ready Practitioners' },
              ].map((item, i, arr) => (
                <div
                  key={i}
          ...
          <h2 className="awe-article-subheading">Leadership Commitment as the Enabling Condition</h2>
          <p>
        ...
        <div style={{
          ...
          <Image
            src="/images/Industry-4.0-scaled.png"
            alt="Dave Phillips"
            width={128}
            height={128}
            unoptimized
          ...
          />
          <div>
            <p style={{ fontSize: "16px", fontWeight: 700, color: "#111111", margin: "0 0 4px 0" }}>Dave Phillips</p>
            <p style={{ fontSize: "14px", color: "#2563eb", fontWeight: 600, margin: "0 0 12px 0" }}>AI Consultant, Chamco Digital</p>
            <p style={{ fontSize: "14px", color: "#555555", lineHeight: 1.6, margin: "0 0 16px 0" }}>
              Dave Phillips leads AI readiness strategy at Chamco Digital, helping enterprises design and implement workforce enablement programs that close the AI skills gap and accelerate technology adoption at scale.
            </p>
            <a
              href="https://www.linkedin.com/company/chamcodigital/?viewAsMember=true"
              target="_blank"
      ...
      <section style={{ backgroundColor: "#ffffff", padding: "80px 24px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div className="art-related-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "28px", marginTop: "40px" }}>
            {[
              {
                image: "/images/CEO-Deric-Gurley-v5.png",
                category: "INSIGHT",
              ...
              {
                image: "/images/Nature-Inspired-Computing.jpg",
                category: "INSIGHT",
                title: "Bio-Inspired AI: Nature's Blueprint for Modern Algorithms",
                excerpt: "How biology-inspired computation is transforming enterprise optimization and strategic decision-making.",
                link: "/nature-inspired-computing",
                external: false,
              },
            ].map((card, i) => (
              <a
              ...
              >
                ...
                <div style={{ padding: "24px" }}>
                  ...
                  <span className="awe-read-more">Read more →</span>
                </div>
              </a>
            ))}
          </div>
